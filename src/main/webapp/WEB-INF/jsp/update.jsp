...
<div class="contact-page-w3ls inner-padding">
    <div class="container">
        <h3 class="heading-agileinfo">修改新闻<span></span></h3>

        <div class="contact-info-w3ls">

            <div class="contact-right-w3layouts">
                <h5 class="title-w3">请修改相关内容</h5><br>

                <form class="form-horizontal" action="/update2" method="post" id="addform">
                    <div class="form-group">
                        <input type="text" name="nid" value="${news.id}" hidden>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-10">
                            <textarea name="content" form="addform"  class="form-control " rows="30" required>${news.content}</textarea>
                        </div>
                    </div>
